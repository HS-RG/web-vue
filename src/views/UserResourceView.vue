        ...
        <div class="common-layout">
            <el-container>
                <el-header class="logo">
                  <a href="javascript:void(0);" class="a"  style="margin-top: 5vh;  font-size: 50px; color:#ffffff;   font-weight: bolder;  text-align: center">资源详情页</a>
                    <div style="vertical-align: middle" class="Touxiang">
                        <el-dropdown style="text-align: right">
                            <div class="account">
                                <img :src="touxiang" alt="头像" class="touxiang"/>
                              <div style="font-weight: bolder;margin-top: 10px; "><div style="color: #020b13">{{wellCome}}</div></div>
                            </div>
                            <template #dropdown>
                                <el-dropdown-menu>
              ...
              <el-dialog v-model="dialogPasswordVisible" title="修改密码" width="30%" center>
                ...
                <el-card style="width: 80vw;height:190px;margin: auto; display: block;">
                    <el-descriptions
                        class="margin-top"
                        title="文件概况"
                        :column="3"
                ...
                <div style="width: 80vw; height: 400px; overflow: auto; margin: auto; display: block;position: relative">
                    <el-card style="background-color: #ffffff; position: absolute;  top: 0;  left: 0;  right: 0;  bottom: 0;">
                        <div v-html="cardContent"></div>
                    </el-card>
                    <el-card  class="background-image1" style=" min-height: 50px; position: absolute;overflow: auto;  top: 0;  left: 0;  right: 0;  bottom: 0;">
